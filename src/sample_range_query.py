...
hh_degree_2 = np.array([44,325,402,485])
hh_degree_3 = np.array([217,217,296,294])
hh_degree_4 = np.array([130,200,202,288])
...
for idx, N in enumerate(flat_ns):
    for degree in degrees:
        ...
        if degree == 2:
            ...
            csv_name = 'range_queries/range_queries/flat' + f'_flat_N={N}_B={degree}_r={flat_degree_2[idx]}.csv'
        elif degree== 3:
            length_array = flat_degree_3

            csv_name = 'range_queries/range_queries/flat' + f'_flat_N={N}_B={degree}_r={flat_degree_3[idx]}.csv'
        elif degree== 4:
            length_array = flat_degree_4
            csv_name = 'range_queries/range_queries/flat' + f'_flat_N={N}_B={degree}_r={flat_degree_4[idx]}.csv'
